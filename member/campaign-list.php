...
<head>
  ...
  <script src="https://kit.fontawesome.com/b95b283785.js" crossorigin="anonymous"></script>
  <!-- Theme style -->
    ...
    <div class="content-wrapper">
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark"><span class="fa fa-flag"></span> Campaign List</h1>
            </div>
            <div class="col-sm-6">
            ...
            <a class="btn btn-sm elevation-2" href="add-campaign.php"
              ...
              <table id="example1" class="table table-bordered table-hover">
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                  ...
                  <tr>
                    ...
                    <td> <img width="200" height="150" src="../assets/posts/<?= $row['banner'] ?>" alt=""></td>
                    <td>
                      <a href="delete.php?cmpdelete=<?= $row['banner'] ?>" class="btn btn-danger"><i
